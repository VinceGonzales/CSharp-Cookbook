...
namespace WebTest1
{
    ...
    public static class MvcMockHelpers
    {
        ...
        public static void SetupRequestUrl(this HttpRequestBase request, string url)
        {
            ...
            mock.Setup(req => req.ApplicationPath).Returns(GetUrlFileName(url));
            mock.Setup(req => req.Params).Returns(GetQueryStringParameters(url));
